'use strict';
const CACHE = 'prorecup-terrain-shell-v1-9';
const SHELL = ['./', './index.html', './css/app.css?v=1-6', './js/config.js?v=1-6', './js/api.js?v=1-6', './js/auth.js?v=1-6', './js/offline.js?v=1-8', './js/app.js?v=1-8', './manifest.webmanifest', './icon.svg'];
